...
buttons_group.appendChild(btn_med);
...
buttons_group.appendChild(btn_hard);

wrapper.appendChild(buttons_group);
...
btn_easy.onclick = (event)=>{
    fetch("http://localhost:3000/easy")
        .then((data)=>{
            ...
            NUMBER_ENEMIES = d.NUMBER_ENEMIES;
            ENEMIES_SPEED  = d.ENEMIES_SPEED;
            ENEMY_HP_DESTRUCTION = d.ENEMY_HP_DESTRUCTION;
            data_retrieved = true;
        })
}
